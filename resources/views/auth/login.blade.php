@extends('layouts.main ', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('FarmaUdo')])
          ...
          <div class="card-body">
            ...
            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                value="{{ old('email', 'admin@material.com') }}" required autocomplete="email" autofocus>
              </div>
              @if ($errors->has('email'))
            ...
            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                value="{{ !$errors->has('password') ? "secret" : "" }}" required autocomplete="new-password">
              </div>
